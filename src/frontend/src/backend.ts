...
export class Backend implements backendInterface {
    ...
    async getPlayerWins(arg0: string): Promise<bigint | null> {
        if (this.processError) {
            try {
                const result = await this.actor.getPlayerWins(arg0);
    ...
    async getRecentWinners(): Promise<Array<string>> {
        if (this.processError) {
            try {
                const result = await this.actor.getRecentWinners();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getScoreboard(): Promise<Array<[string, bigint]>> {
        if (this.processError) {
            try {
    ...
    async getSortedScoreboard(): Promise<Array<PlayerStats>> {
        if (this.processError) {
            try {
                const result = await this.actor.getSortedScoreboard();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getTopPlayers(arg0: bigint): Promise<Array<PlayerStats>> {
        if (this.processError) {
            try {
    ...
    async recordWin(arg0: string): Promise<void> {
        if (this.processError) {
            try {
    ...
    async resetScoreboard(): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.resetScoreboard();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
